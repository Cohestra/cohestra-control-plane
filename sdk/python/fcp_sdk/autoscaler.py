"""Base class for building custom FCP autoscalers."""
...
from fcp_sdk.client import FCPClient, Deployment

logger = logging.getLogger("fcp.autoscaler")
...
class AutoscalerBase(ABC):
    ...
    def __init__(self, client: FCPClient, env: str, namespace: str, name: str):
        self.client = client
