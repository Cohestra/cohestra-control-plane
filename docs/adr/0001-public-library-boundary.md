...
**Status:** Accepted
**Date:** 2026-06-25
**Deciders:** FCP maintainers

## Context

FCP must support community deployments and enterprises with proprietary infrastructure integrations. The original implementation placed all packages under `internal`, preventing reuse, and coupled worker registration to the simulated backend.

## Decision

Publish a vendor-neutral core at `github.com/flink-control-plane/fcp`.
